...
SECRET_KEY = 'django-insecure-4wsydia_uv%rm0tyl)ng0-samf7=5_qub7=hc^5(9x7ot2%aqw'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'ckeditor', #for richtext in blog body
...
DATABASES = {
    'default': {
        ...
        'NAME': 'd6188qgpum971l',
        'USER': 'wyepewwtsbrbkv',
        'PASSWORD': '1995196819c6a78896aaa313c5072700d5c2445d44d00da98acf37c98d1d2806',
